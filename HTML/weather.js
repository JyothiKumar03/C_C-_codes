...
request.onload = function() {
    if( request.status >=200 && request.status < 400) {
        ...
        document.getElementById('tempmax').innerHTML = 'max temperature: '+data.main.temp_max + 'F';
        document.getElementById('tempmin').innerHTML ='min temperature: '+ data.main.temp_min + 'F';
